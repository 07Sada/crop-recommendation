    ...
    def initiate_data_ingestion(self) -> artifact_entity.DataIngestionArtifact:
        try:
            ...
            df: pd.DataFrame = utils.get_collection_as_dataframe(
                                database_name = self.data_ingestion_configdata.database_name,
                                collection_name = self.data_ingestion_configdata.collection_name)
            ...
            dataset_dir = os.path.dirname(self.data_ingestion_configdata.train_file_path)
